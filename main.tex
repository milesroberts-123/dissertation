...
{
%\MakeUppercase{Correlates of conditional expression, pangenomic variation, and selection in plants}

%\MakeUppercase{GxE + phenotype + selection}

%\MakeUppercase{A journey through the distribution of fitness effects in plants}
